  ...
  return (
    <div className="py-12">
      ...
      <p className="text-lg text-center text-neutral-600 dark:text-neutral-400 mb-12 max-w-2xl mx-auto">
        Showcasing our commitment to innovation and excellence. Explore our
        diverse range of projects from AI solutions to impactful web and graphic
        designs.
      </p>
      ...
      <div className="grid md:grid-cols-2 gap-8">
        {filteredProjects.map((project) => (
          <div
            key={project.title}
            className="dark:bg-[#08101f]   dark:hover:shadow-blue-100/45 dark:shadow bg-white rounded-lg shadow-xl overflow-hidden flex flex-col"
          >
            {project.imageUrl && (
            ...
            <div className="p-6 flex flex-col flex-grow">
              ...
              <div className="mt-auto items-center flex space-x-3">
                {project.githubLink && (
                  <Link
                ...
                {project.projectType && (
                  <div>
                    ...
                    <span className="text-xs ml-1 font-semibold text-neutral-500 dark:text-neutral-400">
                      {project.projectType}
                    </span>
                  </div>
                )}
