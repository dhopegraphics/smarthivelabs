    ...
    <div className="py-12">
      <section className="text-center mb-12">
        ...
        <p className="text-lg text-gray-600 max-w-2xl mx-auto">
          Ready to start your next project? Smart Hive Labs offers expert
          services to bring your ideas to life. Fill out the form below, and
          let&apos;s discuss how we can help you achieve your goals.
        </p>
      </section>

      <section className="max-w-3xl mx-auto bg-white p-8 sm:p-10 rounded-xl shadow-2xl">
        ...
        >
          <div className="grid sm:grid-cols-2 gap-6">
            <div>
              ...
              >
                ...
                <User className="inline ml-1 h-4 w-4 text-primary" />
              </label>
              <Input
                type="text"
                name="name"
          ...
          <div>
            ...
            >
              ...
              <Building className="inline ml-1 h-4 w-4 text-primary" />
            </label>
            <Input
              type="text"
              name="company"
          ...
          <div>
            ...
            >
              Service Needed{" "}
              <Zap className="inline ml-1 h-4 w-4 text-primary" />
            </label>
            <Select
              name="service"
            ...
            >
              ...
              <SelectContent className="bg-blue-50  bg-blue-50">
          ...
          <div>
            ...
            >
              ...
              <Lightbulb className="inline ml-1 h-4 w-4 text-primary" />
            </label>
            <Textarea
              name="projectDetails"
              id="projectDetails"
          ...
          <div>
            ...
            >
              ...
              <DollarSign className="inline ml-1 h-4 w-4 text-primary" />
            </label>
            <Input
              type="text"
              name="budget"
      ...
      <section className="mt-16 text-center">
        ...
        <div className="grid sm:grid-cols-3 gap-6 max-w-4xl mx-auto text-gray-600">
          <div className="bg-white  dark:hover:shadow-zinc-900 hover:shadow-blue-200  p-6 rounded-lg shadow-lg">
          ...
          <div className="bg-white p-6 rounded-lg dark:hover:shadow-zinc-900 hover:shadow-blue-200  shadow-lg">
            <Zap size={32} className="mx-auto mb-3 text-primary" />
            <h4 className="font-semibold text-lg mb-1 text-gray-900">
              Technical Prowess
            </h4>
            <p className="text-sm">
              Utilizing the latest technologies for robust and scalable results.
            </p>
          </div>
          <div className="bg-white p-6 rounded-lg dark:hover:shadow-zinc-900 hover:shadow-blue-200  shadow-lg">
